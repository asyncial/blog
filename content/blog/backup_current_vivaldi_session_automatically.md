...
The last script is a starter script. It assumes the backup script and the vivaldi-bin file in the ```$PATH```. It is just called [vivaldi](https://raw.githubusercontent.com/asyncial/bin/master/vivaldi) and starts Vivaldi, as well as the backup script, after a short waiting time, to let vivaldi finish its startup.
